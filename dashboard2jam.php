...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($sensor_data): ?>
                            ...
                            <div class="timestamp-card">
                                <div class="row">
                                    <div class="col-md-6">
                                        <strong>🕐 Waktu Sekarang:</strong><br>
                                        <span id="current-time-display" style="font-size: 1.1em; color: #28a745;">
                                            Loading...
                                        </span>
                                    </div>
                                    <div class="col-md-6">
                                        <strong>📅 Terakhir Update:</strong><br>
                                        <span id="timestamp-display" style="font-size: 1.1em; color: #667eea;">
                                            <?php 
    ...
    <script>
        ...
        // Auto refresh data setiap 30 detik (sesuai ESP8266)
        setInterval(() => {
            if (deviceCode) {
                ...
                .then(data => {
                    if (data.suhu !== undefined && data.kelembaban !== undefined) {
                        ...
                        // Update timestamp data terakhir jika ada perubahan
                        if (data.tanggal && data.waktu) {
                            ...
                            if (newTimestamp !== lastTimestamp) {
                                ...
                                timestampElement.setAttribute('data-base-text', newTimestamp);
                                timestampElement.setAttribute('data-timestamp', new Date().toISOString());
        ...
        }, 30000); // Update data setiap 30 detik (sesuai ESP8266)

        // Update jam real-time setiap detik
        setInterval(updateCurrentTime, 1000);

        // Update relative time setiap 5 detik
        setInterval(updateRelativeTime, 5000);

        // Inisialisasi waktu saat halaman load
        updateCurrentTime();
        
        // Setup timestamp element attributes
        const timestampElement = document.getElementById('timestamp-display');
        if (timestampElement && lastTimestamp) {
            timestampElement.setAttribute('data-base-text', lastTimestamp);
            timestampElement.setAttribute('data-timestamp', new Date().toISOString());
        }
    </script>
</body>
